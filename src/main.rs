...
color blue "\<(toggle|addr|save|iso|space)\>"
...
fn print_help() {
    ...
    println!("  --disk <file>                 Sets disk device to that file");
    ...
    println!("  --force                       Bypass any disk checks");
    println!("  --help                        Show this help message");
    println!("  --loop                        Loop the file input contents");
    println!("  --o, --output <file>          Set output filename");
    println!("  --raw-disk <file>             Set the raw bytes disk to file");
    println!("  --readonly                    Deny all disk write calls");
